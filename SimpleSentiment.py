...
import transformers
import pandas as pd
from transformers import pipeline #NLP's Transformer is a new architecture that aims to solve tasks sequence-to-sequence while easily handling long-distance dependencies
